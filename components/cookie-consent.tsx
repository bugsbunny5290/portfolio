...
const content = {
  en: {
    ...
    description:
      "This website uses Vercel Analytics to collect anonymous usage data, including page views, referrers, and device information. No personally identifiable information is collected or shared with third parties.",
  ...
  de: {
    ...
    description:
      "Diese Website verwendet Vercel Analytics zur Erfassung anonymer Nutzungsdaten, einschliesslich Seitenaufrufe, Referrer und Gerateinformationen. Es werden keine personenbezogenen Daten erhoben oder an Dritte weitergegeben.",
    purpose:
      "Zweck: Um zu verstehen, wie Besucher diese Seite nutzen und das Nutzererlebnis zu verbessern.",
    storage: "Datenspeicherung: Analytics-Daten werden bis zu 30 Tage gespeichert.",
    rights:
      "Sie konnen Ihre Einwilligung jederzeit widerrufen, indem Sie den lokalen Speicher Ihres Browsers loschen.",
...
export function CookieConsent({
  onAccept,
  onDecline,
}: CookieConsentProps): React.ReactElement | null {
